...
//genes ojos
   //RESP1
   string Ojosresp1="";
   Ojosresp1+=this->getGeneOjos()[0];
   Ojosresp1+= per.getGeneOjos()[0];
   //RESP2
   string Ojosresp2;
   Ojosresp2+=this->getGeneOjos()[0];
   Ojosresp2+= per.getGeneOjos()[1];
   //RESP3
   string Ojosresp3;
   Ojosresp3+=this->getGeneOjos()[1];
   Ojosresp3+= per.getGeneOjos()[0];
   //RESP4
   string Ojosresp4;
   Ojosresp4+=this->getGeneOjos()[1];
   Ojosresp4+= per.getGeneOjos()[1];
//genes PELO
      string adnpelo=per.getGenePelo(), adnpiel=per.getGenePiel(),adnojos=per.getGeneOjos(); 
   //RESP1
   string Peloresp1;
   Peloresp1+=this->getGenePelo()[0];
   Peloresp1+= per.getGeneOjos()[0];
   //RESP2
   string Peloresp2;
   Peloresp2+=this->getGenePelo()[0];
   Peloresp2+= per.getGenePelo()[1];
   //RESP3
   string Peloresp3;
   Peloresp3+=this->getGenePelo()[1];
   Peloresp3+= per.getGenePelo()[0];
   //RESP4
   string Peloresp4;
   Peloresp4+=this->getGenePelo()[1];
   Peloresp4+=per.getGenePelo()[1];
//genes PIEL
   //RESP1
   string Pielresp1;
   Pielresp1+=this->getGenePiel()[0];
   Pielresp1+= per.getGenePiel()[0];
   //RESP2
   string Pielresp2;
   Pielresp2=this->getGenePiel()[0];
   Pielresp2+= per.getGenePiel()[1];
   //RESP3
   string Pielresp3;
   Pielresp3=this->getGenePiel()[1];
   Pielresp3+= per.getGenePiel()[0];
   //RESP4
   string Pielresp4;
   Pielresp4=this->getGenePiel()[1];
